...
class UserProvider extends ChangeNotifier {
  ...
  Future<void> refreshMainUser() async {
    final temp = await FirestoreServices.fetchUser(_mainUser.uID);
    if (temp != null) setMainUser(temp);
  }
